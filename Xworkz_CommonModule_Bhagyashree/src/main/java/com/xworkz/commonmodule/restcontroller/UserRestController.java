...
public class UserRestController {
    ...
    public String onName(@PathVariable String name){
        ...
        Long count = this.userService.countByName(name);
        if (count == 0) {
    ...
    public String onEmail(@PathVariable String email) {
        ...
        Long count = this.userService.countByEmail(email);
        if (count == 0) {
            System.out.println("does not exist");
        } else {
            System.out.println("exists");
    ...
    public String onPhone(@PathVariable long phone) {
        ...
        Long count = this.userService.countByPhone(phone);
        if (count == 0) {
            System.out.println("does not exist");
        } else {
            System.out.println("exists");
    ...
    public String onAlterEmail(@PathVariable String alterEmail) {
        ...
        Long count = this.userService.countByAlterEmail(alterEmail);
        if (count == 0) {
            System.out.println("does not exist");
        } else {
            System.out.println("exists");
    ...
    public String onAlterPhone(@PathVariable long alterPhone) {
        ...
        Long count = this.userService.countByAlterPhone(alterPhone);
        if (count == 0) {
            System.out.println("does not exist");
        } else {
            System.out.println("exists");
